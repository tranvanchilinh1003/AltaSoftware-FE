...
const QAFromSearch: React.FC<StudentRetentionListFromSearchProps> = ({
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`
                        ...
                        w-full sm:w-[320px] md:w-[380px] lg:w-[420px] xl:w-[438px] 2xl:w-full
