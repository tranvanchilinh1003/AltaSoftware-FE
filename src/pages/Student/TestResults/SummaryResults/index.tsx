...
const SummaryResults = () => {
  return (
    <div className="mr-7 pt-8">
      <div className="flex flex-col items-center justify-center p-6 border border-orange-300 rounded-lg shadow-md w-full">
        <h2 className="text-lg font-Mulish text-center mb-4 text-gray-800 mb-20" style={{ fontSize: '28px' }}>
          Tổng điểm kiểm tra
        </h2>
        <div className="flex items-center w-full justify-between px-8">
          ...
          <div className="grid grid-cols-4 gap-6 w-full text-center">
            <div>
              <p className="text-orange-500 text-2xl font-bold" style={{ fontSize: '48px' }}>
                8.0/10
              </p>
              <p className="text-gray-800 font-semibold" style={{ fontSize: '28px' }}>
                Tổng điểm
              </p>
            </div>
            <div className="border-l-2 border-orange-400 pl-4">
              <p className="text-orange-500 text-lg font-bold" style={{ fontSize: '36px' }}>
                Tổng 20
              </p>
            ...
            <div className="border-l-2 border-blue-400 pl-4">
              <p className="text-blue-500 text-lg font-bold" style={{ fontSize: '36px' }}>
                16
              </p>
              <p className="text-gray-700" style={{ fontSize: '18px' }}>
                Đáp án đúng
